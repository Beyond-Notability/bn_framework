...
- First, and most obviously, the data selected is the data that is interpreted. Add in some more data, such as instances of when women '[spoke at](https://beyond-notability.wikibase.cloud/wiki/Property:P23)' a meeting, conference, or congress at the patterns change, with few women recorded as speaking until later in life, usually after having served on a committee or held a role.
