---
theme: dashboard
title: Events networks improved!
toc: false
---
...
- Node colours represent automatically-detected groups. (It's worth looking out for people who have links to more than one group even if they don't have many links, eg Alice Edleston.)
- Completely isolated nodes were removed from the network.


Zoom, drag, etc, plus highlighting connected nodes is working correctly! (though can be slightly temperamental)
